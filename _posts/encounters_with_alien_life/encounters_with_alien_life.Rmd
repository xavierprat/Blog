...
Enrico Fermi was know for many things, among them he was also known to guesstimate a number, a back of the envelope
...
The dimensions of the universe are too large and information (even matter) travels way too slow. Some numbers to show such vastness:
...
- Technology limitations: spaceships not fast enough
  - Speed of light limitations: E=mc2
...
Considering only alien life capable of civilization, we may not share a time window between the time to develop a technology for communication and the time of self-destruction.
Now are are getting outside of physics and more perhaps into history or anthropology. In other words,
we have too look into how civilizations are created, evolve, perhaps reach a technological state, and eventually fade.

For each living society as it progresses or changes, it can plateau in 4 different ways.

1. It never achieves the technology for space exploration and communication
...
3. Self-destruction: The very genes making us a superior species, the survival and selfish genes 
which made us survive and thrive are now threatening our self-destruction. 
...
themselves. 
    ...
    3.1 Replaced by AI to overcome our primitive genes: this is perhaps the only possible way out to avoid self-destruction
  
4. Hedonic decline: We have to remember that our intrinsic need to explore space comes from our genes that
makes us improve our lives.
Will we still have the need to explore space? If technology provides all the primitive genetic needs maybe a civilization will stop exploring and will settle. We will be connected to VR worlds with VR
...
Being this third category by definition the largest.
